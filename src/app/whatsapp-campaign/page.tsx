        ...
        <main className="flex-1 px-8 flex flex-col">
          ...
          <div className="pb-6">
            <a
              ...
              className="flex items-center justify-center gap-3 w-full bg-[#25D366] text-white py-[1.6rem] rounded-2xl font-extrabold text-xl transition-all active:scale-[0.97] hover:brightness-110"
